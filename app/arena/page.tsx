        ...
        <div className="flex-1">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              <Sword className="w-6 h-6 text-brand-magenta" />
              <h2 className="text-2xl font-bold tracking-tight uppercase font-mono">Battle_Arena</h2>
            </div>
            <button className="px-6 py-2 rounded-lg bg-brand-magenta text-white font-bold text-xs hover:shadow-[0_0_15px_var(--color-brand-magenta)] transition-all uppercase tracking-widest">
              Create_Lobby
            </button>
          </div>
              ...
              >
                ...
                <div className="flex items-center gap-6">
                  <div className="text-right hidden sm:block">
                    ...
                    <p className="text-lg font-black text-brand-yellow">{battle.reward}</p>
                  </div>
                  <button 
                    onClick={() => handleJoin(battle)}
                    className="px-8 py-3 rounded-xl border border-brand-magenta text-brand-magenta font-bold uppercase tracking-widest text-xs hover:bg-brand-magenta hover:text-white transition-all"
                  >
                    Join_Battle
                  </button>
                </div>
