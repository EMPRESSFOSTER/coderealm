...
*   **Terminal Breach (Minigame)**: A hacking-themed, 5-letter web-development word guessing sequence to bypass firewalls and earn credits.
...
*   `/app`: Next.js 15 App Router pages and layouts.
    ...
    *   `/app/puzzle`: The Data Decrypt Protocol memory matrix minigame.
    *   `/app/breach`: The Terminal Breach sequence guessing minigame.
